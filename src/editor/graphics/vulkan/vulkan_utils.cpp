...
const char* vkResultToString(VkResult result)
{
    ...
    case VK_THREAD_IDLE_KHR:
        return "VK_THREAD_IDLE_KHR A deferred operation is not complete but "
               "there is currently no work for this thread to do at the time "
               "of this call.";
    case VK_THREAD_DONE_KHR:
        return "VK_THREAD_DONE_KHR A deferred operation is not complete but "
               "there is no work remaining to assign to additional threads.";
    case VK_OPERATION_DEFERRED_KHR:
        return "VK_OPERATION_DEFERRED_KHR A deferred operation was requested "
               "and at least some of the work was deferred.";
    case VK_OPERATION_NOT_DEFERRED_KHR:
        return "VK_OPERATION_NOT_DEFERRED_KHR A deferred operation was "
               "requested and no operations were deferred.";
    case VK_PIPELINE_COMPILE_REQUIRED:
        return "VK_PIPELINE_COMPILE_REQUIRED A requested pipeline creation "
               "would have required compilation, but the application requested "
               "compilation to not be performed.";
    case VK_INCOMPATIBLE_SHADER_BINARY_EXT:
        return "VK_INCOMPATIBLE_SHADER_BINARY_EXT The provided binary shader "
               "code is not compatible with this device.";

    // Error Codes
    case VK_ERROR_OUT_OF_HOST_MEMORY:
        return "VK_ERROR_OUT_OF_HOST_MEMORY A host memory allocation has "
               "failed.";
    case VK_ERROR_OUT_OF_DEVICE_MEMORY:
        return "VK_ERROR_OUT_OF_DEVICE_MEMORY A device memory allocation has "
               "failed.";
    case VK_ERROR_INITIALIZATION_FAILED:
        return "VK_ERROR_INITIALIZATION_FAILED Initialization of an object "
    ...
    case VK_ERROR_MEMORY_MAP_FAILED:
        return "VK_ERROR_MEMORY_MAP_FAILED Mapping of a memory object has "
               "failed.";
    ...
    case VK_ERROR_INCOMPATIBLE_DRIVER:
        return "VK_ERROR_INCOMPATIBLE_DRIVER The requested version of Vulkan "
    ...
    case VK_ERROR_FORMAT_NOT_SUPPORTED:
        return "VK_ERROR_FORMAT_NOT_SUPPORTED A requested format is not "
    ...
    case VK_ERROR_NATIVE_WINDOW_IN_USE_KHR:
        return "VK_ERROR_NATIVE_WINDOW_IN_USE_KHR The requested window is "
               "already in use by Vulkan or another API in a manner which "
               "prevents it from being used again.";
    case VK_ERROR_OUT_OF_DATE_KHR:
        return "VK_ERROR_OUT_OF_DATE_KHR A surface has changed in such a way "
    ...
    case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
        return "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR The display used by a "
               "swapchain does not use the same presentable image layout, or "
               "is incompatible in a way that prevents sharing an image.";
    case VK_ERROR_INVALID_SHADER_NV:
        return "VK_ERROR_INVALID_SHADER_NV One or more shaders failed to "
               "compile or link. More details are reported back to the "
               "application via VK_EXT_debug_report if enabled.";
    case VK_ERROR_OUT_OF_POOL_MEMORY:
        return "VK_ERROR_OUT_OF_POOL_MEMORY A pool memory allocation has "
               "failed. This must only be returned if no attempt to allocate "
               "host or device memory was made to accommodate the new "
               "allocation. If the failure was definitely due to fragmentation "
               "of the pool, VK_ERROR_FRAGMENTED_POOL should be returned "
               "instead.";
    case VK_ERROR_INVALID_EXTERNAL_HANDLE:
        return "VK_ERROR_INVALID_EXTERNAL_HANDLE An external handle is not a "
               "valid handle of the specified type.";
    case VK_ERROR_FRAGMENTATION:
        return "VK_ERROR_FRAGMENTATION A descriptor pool creation has failed "
               "due to fragmentation.";
    case VK_ERROR_INVALID_OPAQUE_CAPTURE_ADDRESS: // VK_ERROR_INVALID_DEVICE_ADDRESS_EXT
    ...
    case VK_ERROR_VALIDATION_FAILED_EXT:
        return "VK_ERROR_VALIDATION_FAILED_EXT A command failed because "
               "invalid usage was detected by the implementation or a "
               "validation-layer.";
    case VK_ERROR_COMPRESSION_EXHAUSTED_EXT:
        return "VK_ERROR_COMPRESSION_EXHAUSTED_EXT An image creation failed "
               ...
               "exhausted. This must only be returned when fixed-rate "
    ...
    case VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR:
        return "VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR Format "
    ...
    case VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR:
        return "VK_ERROR_VIDEO_STD_VERSION_NOT_SUPPORTED_KHR The specified "
               "video Std header version is not supported.";
    case VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR:
        return "VK_ERROR_INVALID_VIDEO_STD_PARAMETERS_KHR The specified Video "
               "Std parameters do not adhere to the syntactic or semantic "
               ...
               "used video compression standard do not adhere to the "
               "capabilities of the video compression standard or the "
               "implementation.";
